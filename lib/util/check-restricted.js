...
/** @typedef {import('./import-target.js').ImportTarget} ImportTarget */
/**
 ...
 * @param {import('./import-target.js').ImportTarget} importee The importee information.
 */
...
class Restriction {
     ...
     * @param {import('./import-target.js').ImportTarget} importee The importee to check.
 ...
 * @returns {void}
 */
export function checkForRestriction(context, targets) {
