...
import _module_semver_module from "semver";
const { rsort } = _module_semver_module;
import { ReferenceTracker } from "@eslint-community/eslint-utils";
import { getConfiguredNodeVersion } from "./get-configured-node-version.js";
import { getSemverRange } from "./get-semver-range.js";
import { unprefixNodeColon } from "./unprefix-node-colon.js";
 ...
 * @returns {void}
 */
export function checkUnsupportedBuiltins(
    context,
    traceMap
) {
...
const checkUnsupportedBuiltinReferencesExport = checkUnsupportedBuiltinReferences
export { checkUnsupportedBuiltinReferencesExport as checkUnsupportedBuiltinReferences }
