...
const Readable = {
    ...
    isDisturbed: {
        [READ]: { experimental: ["16.8.0"], supported: ["22.17.0", "24.0.0"] },
    },
    fromWeb: {
...
const Stream = {
    ...
    isErrored: {
        [READ]: {
            ...
            supported: ["22.17.0", "24.0.0"],
        },
    },
    isReadable: {
        [READ]: {
            experimental: ["17.4.0", "16.14.0"],
            supported: ["22.17.0", "24.0.0"],
        },
    },
...
module.exports = {
    ...
    "node:_stream_duplex": { [READ]: { deprecated: ["24.2.0"] } },
    "node:_stream_passthrough": { [READ]: { deprecated: ["24.2.0"] } },
    "node:_stream_readable": { [READ]: { deprecated: ["24.2.0"] } },
    "node:_stream_transform": { [READ]: { deprecated: ["24.2.0"] } },
    "node:_stream_wrap": { [READ]: { deprecated: ["24.2.0"] } },
    "node:_stream_writable": { [READ]: { deprecated: ["24.2.0"] } },
}
